...
function preload() {
    ...
    birdDrag = loadSound("sounds/bird_select.mp3");
...
function setup(){
    ...
    birdArray.push(bird4,bird3,bird2,bird);
}
...
function keyPressed(){
    if(keyCode === 32){
       Matter.Body.setPosition(birdArray[birdArray.length-1].body,{x:200, y:20});
